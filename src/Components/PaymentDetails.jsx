                            ...
                            <form class="w-full max-w-lg">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-2">
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                        ...
                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city" type="text" placeholder="07/22" />
                                    </div>
                                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <p className='flex text-xs text-black'><img src={checkicon}/>Make this my Default Credit Card</p>
                                </div>
                            </form>
